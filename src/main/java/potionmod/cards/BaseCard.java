...
import potionmod.util.CardStats;
import potionmod.util.TriFunction;
...
import static potionmod.util.GeneralUtils.removePrefix;
...
public abstract class BaseCard extends CustomCard {
    ...
    protected static String makeID(String name) { return PotionMod.makeID(name); }
